...
/**
 * @author Gabriel Baril <gabriel_baril@hotmail.com>
 * Date: 2017-02-22
...
// DEBUT Paramètres du site
    ...
    if ($blnLocal) {
        ...
        $strBdUsername = "root";
        $strBdPassword = "root";
        $strBdName = "bdspec2017";
    } else {
        $strBdServer   = 'gabrielbaril.ca';
        $strBdUsername = 'gbaril';
        $strBdPassword = 'B@lanc3d';
        $strBdName     = 'spec2017_gabriel';
    }
    ...
    //$resultat=$objConnMySQLi->query('SELECT titre, id_livre FROM t_livre');
    //var_dump($resultat);
